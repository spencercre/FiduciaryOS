    ...
    return (
        <div className="space-y-6 animate-fadeIn relative">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-stone-900 p-6 rounded-lg shadow-lg text-stone-300"><div className="flex justify-between items-start mb-4"><h3 className="font-serif text-xl font-bold text-white">The Iron Key</h3><Key className="text-amber-500" size={24} /></div><p className="text-sm mb-6 leading-relaxed">Upon confirmed incapacity, the <strong>Master Encryption Key</strong> will be securely transmitted.</p><div className="space-y-3"><div className="flex items-center p-3 bg-stone-800 rounded border border-stone-700"><div className="w-8 h-8 rounded-full bg-stone-700 flex items-center justify-center text-white font-bold font-serif mr-3">1</div><div><p className="text-sm font-bold text-white">Primary Successor</p><p className="text-xs text-stone-400">Sarah Jenkins (Partner)</p></div><CheckCircle size={16} className="text-racing-green ml-auto" /></div><div className="flex items-center p-3 bg-stone-800/50 rounded border border-stone-700/50"><div className="w-8 h-8 rounded-full bg-stone-700/50 flex items-center justify-center text-stone-400 font-bold font-serif mr-3">2</div><div><p className="text-sm font-bold text-stone-400">Secondary Successor</p><p className="text-xs text-stone-500">U.S. Bank Corporate Trust · (800) 934-6802</p></div><Clock size={16} className="text-stone-500 ml-auto" /></div></div><button onClick={() => setShowConfig(true)} className="w-full mt-6 py-3 border border-stone-600 rounded text-stone-400 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest">Configure Protocols</button></div>
             </div>
