...
import { NexusWarningBanner } from '../components/trust/NexusWarningBanner';
...
import { Documents as Vault } from './Documents';
  ...
  return (
    <div className="space-y-6">
      ...
      {showNexusWarning && isPrivileged && (
        <NexusWarningBanner trust={trust} />
      )}
